class PipelineLens < Formula
  ...
  url "https://github.com/Jimon-s/pipeline-lens/archive/refs/tags/v1.0.1.tar.gz"
  version "v1.0.1"
  sha256 "26b49fb3e640291156336907937db7850ea614ff302e316c399be2b780c3e9f0"
  license "MIT"
  ...
  def install
    ...
    output = Utils.safe_popen_read("cat", "#{buildpath}/completions/zsh_completion")
    (zsh_completion/"_pipeline-lens").write output
  end
